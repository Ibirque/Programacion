...
public class CuentaUF4 {
    private String id;
    private String nombre;
    private float saldo;

    public CuentaUF4(String id, String nombre) {
        this.id = id;
        this.nombre = nombre;
    }

    public CuentaUF4(String id, String nombre, float saldo) {
        this.id = id;
        this.nombre = nombre;
        this.saldo = saldo;
    }
    ...
    //igual que debito
    public float Transferencia(CuentaUF4 CuentaUF42, float cantidad) {
        if (cantidad < CuentaUF42.saldo) {
            CuentaUF42.saldo = CuentaUF42.saldo - cantidad;
            this.saldo = this.saldo + cantidad;
            return this.saldo;
        } else {
